...
prompt_preview: "---\nname: claude-api\ndescription: |-\n  Reference for the Claude\
  ...
  \ prompt names Claude/Anthropic in any form (Claude, Anthropic, Opus, Sonnet, Haiku,\
  \ `anthropic`, `@anthropic-ai`, `claude-*`, `us.anthropic.*`, `[1m]`); the user\
  \ asks about an LLM (pricing/model choi..."
full_prompt_length: 35316
tools_mentioned:
- Python
- python
- java
...
fetched_at: '2026-06-08T06:41:50.540495Z'
evaluation:
  model: xiaomi/mimo-v2-flash:free
  evaluated_at: '2026-06-08T07:03:21.128269Z'
  prompt_quality:
    score: 3.0
    reasoning: 'Evaluation error: RetryError[<Future at 0x7f80967fe990 state=finished
      raised HTTPError>]'
  usefulness:
    score: 3.0
    reasoning: 'Evaluation error: RetryError[<Future at 0x7f80967fe990 state=finished
...
github_metrics:
  ...
  fetched_at: '2026-06-08T06:41:57.390016Z'
indexed_at: '2026-06-08T07:07:01.930838Z'
---
