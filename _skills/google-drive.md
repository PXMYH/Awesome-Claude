...
prompt_preview: "---\nname: google-drive\ndescription: |\n  Interact with Google Drive\
  \ - search files, find folders, list contents, and download files.\n  Use when user\
  \ asks to: search Google Drive, find a file/folder, list Drive contents,\n  download\
  \ a file from Drive, or browse Drive folders. Lightweight alternative to full\n\
  \  Google Workspace MCP server with standalone OAuth authentication.\n---\n\n# Google\
  \ Drive\n\nLightweight Google Drive integration with standalone OAuth authentication.\
  \ No MCP server required.\n\n> **⚠..."
full_prompt_length: 2919
tools_mentioned:
- python
category: community
...
fetched_at: '2026-01-25T03:52:35.406969+00:00'
evaluation:
...
github_metrics:
  ...
  open_issues: 0
  last_commit: null
  fetched_at: '2026-01-25T04:05:53.050271Z'
indexed_at: '2026-01-25T04:05:53.050277Z'
---
