...
prompt_preview: "---\nname: health-check\ndescription: Runs plugin health checks (venv\
  ...
  \n## Workflow\n\n**IMPORTANT: Do NOT use Bash for any step. Use only the tools listed\
  \ below.**\n\n1. Use the `ToolSearch` tool..."
full_prompt_length: 1633
tools_mentioned: []
category: community
...
fetched_at: '2026-05-24T06:00:08.215898+00:00'
evaluation:
  model: xiaomi/mimo-v2-flash:free
  evaluated_at: '2026-05-24T06:53:35.616134Z'
  prompt_quality:
    score: 3.0
    reasoning: 'Evaluation error: RetryError[<Future at 0x7f7319669310 state=finished
      raised HTTPError>]'
  usefulness:
    score: 3.0
    reasoning: 'Evaluation error: RetryError[<Future at 0x7f7319669310 state=finished
...
github_metrics:
  ...
  open_issues: 0
  last_commit: null
  fetched_at: '2026-05-24T08:43:17.719741Z'
indexed_at: '2026-05-24T08:43:17.719746Z'
---
